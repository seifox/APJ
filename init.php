...
define("PERSISTENT_CONNECTION",FALSE); // Define si las conexiones a base de datos son Persistentes o no
define("ATTR_EMULATE_PREPARES",FALSE); // Define si emula la preparación de las consultas con parámetros
